...
BME280TemperatureHumiditySensorAccessory *acc = new BME280TemperatureHumiditySensorAccessory();
...
void setup() {
  ...
  hkServer = new HKServer(acc->getDeviceType(),"Temperature&Humidity","523-12-643",progress);
