...
#include "HKServer.h"
#include "HKLog.h"
#include "AdapticaDoorOpenerAccessory.h"

SerialLogHandler logHandler;


AdapticaDoorOpenerAccessory *acc = new AdapticaDoorOpenerAccessory();
...
void setup() {
  ...
  hkServer = new HKServer(acc->getDeviceType(),"AdapticaDoorOpener","523-12-643",progress);
